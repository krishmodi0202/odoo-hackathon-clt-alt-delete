      ...
      <div className="bg-white p-8 rounded-lg shadow-xl w-96">
        ...
        {error && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
            {typeof error === 'string' && error ? error : (error?.message ? error.message : Array.isArray(error) ? error.join(', ') : (error && typeof error === 'object' && Object.keys(error).length > 0 ? JSON.stringify(error) : 'An error occurred'))}
          </div>
        )}
